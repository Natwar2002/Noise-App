        ...
        <div className="min-h-screen">
            ...
            <div className="container mx-auto px-6 py-20">
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-16">
                    <Card className="bg-black/20 backdrop-blur-lg border-purple-500/20">
                        <CardHeader className="pb-2">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-xl font-bold text-white">Endless Chatter</h3>
                            </div>
                        </CardHeader>
                        <CardBody>
                    ...
                    <Card className="bg-black/20 backdrop-blur-lg border-blue-500/20">
                        <CardHeader className="pb-2">
                            <div className="flex items-center gap-3">
                    ...
                    <Card className="bg-black/20 backdrop-blur-lg border-indigo-500/20">
                        <CardHeader className="pb-2">
                            <div className="flex items-center gap-3">
                                <Users className="text-indigo-400" size={32} />
                                <h3 className="text-xl font-bold text-white">Group Chaos</h3>
                            </div>
                        </CardHeader>
                        <CardBody>
                ...
                <div className="text-center mb-16">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        <div className="text-center">
                            ...
                            <div className="text-purple-200">Messages sent into the void</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl font-black text-blue-400">42</div>
                            <div className="text-blue-200">Meaning of life discovered</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl font-black text-indigo-400">0</div>
                            <div className="text-indigo-200">Productive conversations</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl font-black text-pink-400">100%</div>
                            <div className="text-pink-200">Chance of addiction</div>
                        </div>
                    </div>
                    <p className="text-sm text-gray-400 mt-4">*Statistics may be slightly exaggerated</p>
                </div>
